...
class LungSegTrain(Dataset):
    '''
    Define a Data Loader class for training Set
    '''
    ...
    def __getitem__(self, index):
        '''
        Reads the Training images and masks from path, 
        and applies transformations to it.
        '''
...
class LungSegVal(Dataset):
    '''
    Define a Data Loader class for Validation Set
    '''
    ...
    def __getitem__(self, index):
        '''
        Reads the Validation images and masks from path, 
        and applies transformations to it.
        '''
